...
# This code was generated from wlmData.h using
...
# Base Operation Constants (To be used exclusively, only one of this list at a
# time, but still can be combined with "Measurement Action Addition Constants".
# See below.)
cCtrlStopAll = cStop
...
# Additional Operation Flag Constants (combine with "Base Operation Constants"
# above.)
cCtrlDontOverwrite = 0x0000
cCtrlOverwrite = 0x1000  # don't combine with cCtrlFileDialog
cCtrlFileGiven = 0x0000
cCtrlFileDialog = 0x2000  # don't use with cCtrlOverwrite and cCtrlFileASCII
...
# Unit Constants for Get-/SetResultMode, GetLinewidth, Convert... and
# Calibration
...
# Return flags of ControlWLMEx in combination with Show or Hide, Wait and
# Res = 1
